			       ...
			       <?php if($get['thongtin_1'] != null){ ?>
			        <div class="col-md-3 col-sm-4 col-xs-12  p-5 field-search">
                        <div class="input-group c-square">
                            ...
                            <input type="text" class="form-control c-square" value="" placeholder="Tìm kiếm <?=$thongtin1[0];?>" name="thongtin1">
			      ...
			      <?php } ?>
			       ...
			       <?php } ?>
			        ...
			        <div class="col-md-3 col-sm-4 col-xs-12  p-5 field-search">
                        <div class="input-group c-square">
                            ...
                            <input type="text" class="form-control c-square" value="" placeholder="Tìm kiếm <?=$thongtin2[0];?>" name="thongtin2">
			       ...
			       <div class="col-md-3 col-sm-4 col-xs-12  p-5 field-search">
                        <div class="input-group c-square">
                            ...
                            <input type="text" class="form-control c-square" value="" placeholder="Tìm kiếm <?=$thongtin3[0];?>" name="thongtin3">
			       ...
			       <?php } ?>
			        ...
			        <div class="col-md-3 col-sm-4 col-xs-12  p-5 field-search">
                        <div class="input-group c-square">
                            ...
                            <input type="text" class="form-control c-square" value="" placeholder="Tìm kiếm <?=$thongtin4[0];?>" name="thongtin4">
 ...
 <div class="col-sm-6 col-md-3">
                            <div class="classWithPad">
                                ...
                                <div class="description">
                                  <?=html_entity_decode($bv['thongtin']);?>
                                </div>
                    ...
                    <?php } ?>
                                ...
                                <div class="a-more">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <div class="price_item"><?=number_format($bv['giatien']);?>đ</div>
                                        </div>
                                        <div class="col-xs-6 ">
                                            <div class="view">
