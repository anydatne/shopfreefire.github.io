        ...
        <div class="container">
            ...
            <div class="c-shop-product-details-4">
                        ...
                        <div class="c-product-meta">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xs-12 c-product-variant">
                                                                            <p class="c-product-meta-label c-product-margin-1 c-font-uppercase c-font-bold">Nổi bật: <span class="c-font-red"><?=html_entity_decode($get_bv['thongtin']);?></span></p>
                ...
                <div class="c-product-meta visible-md visible-lg">
                    ...
                    <div class="row">
                     <?php 
                     if($get_bv['thongtin_1'] != null){
                         echo '<div class="col-sm-4 col-xs-6 c-product-variant">
<p class="c-product-meta-label c-product-margin-1 c-font-uppercase c-font-bold">'.$thongtin1[0].': <span class="c-font-red">'.$get_bv['thongtin_1'].'</span></p>
</div>';
                     } 
                     if($get_bv['thongtin_2'] != null){ 
                      echo '<div class="col-sm-4 col-xs-6 c-product-variant">
<p class="c-product-meta-label c-product-margin-1 c-font-uppercase c-font-bold">'.$thongtin2[0].': <span class="c-font-red">'.$get_bv['thongtin_2'].'</span></p>
</div>';  
                     } 
                     if($get_bv['thongtin_3'] != null){
                         echo '<div class="col-sm-4 col-xs-6 c-product-variant">
<p class="c-product-meta-label c-product-margin-1 c-font-uppercase c-font-bold">'.$thongtin3[0].': <span class="c-font-red">'.$get_bv['thongtin_3'].'</span></p>
</div>';
                     }          
                     if($get_bv['thongtin_4'] != null){
                        echo '<div class="col-sm-4 col-xs-6 c-product-variant">
<p class="c-product-meta-label c-product-margin-1 c-font-uppercase c-font-bold">'.$thongtin4[0].': <span class="c-font-red">'.$get_bv['thongtin_4'].'</span></p>
</div>'; 
                     }   
                     ?>
